...
<body>
    ...
    <div class="justificado">
        YO, <b><u>&nbsp;&nbsp;&nbsp;&nbsp;{{ $data->nombre_dela_contrayente }}  &nbsp;&nbsp;&nbsp;&nbsp;</u></b>
        DE NACIONALIDAD <b><u>
                &nbsp;&nbsp;&nbsp;&nbsp;{{ $data->nacion_dela_contrayente == 'P' ? 'PERUANA' : 'EXTRANJERA' }}
                &nbsp;&nbsp;&nbsp;&nbsp; </u></b> CON DOCUMENTO DE IDENTIDAD
        No. <b> <u> &nbsp;&nbsp;&nbsp;&nbsp;{{ $data->di_dela_contrayente }} &nbsp;&nbsp;&nbsp;&nbsp; </u></b>
    </div>
    ...
    <p class="justificado">
        QUE, MI DOMICILIO HABITUAL Y DE PERMANENCIA ES EN: <b><u>
                &nbsp;&nbsp;&nbsp;&nbsp;{{ $data->dir_dela_contrayente }} &nbsp;&nbsp;&nbsp;&nbsp; </u></b> PARA CUYO
